...
const defaultOrigamiPageData = {
  ...
  howItWorks: {
    ...
    subtitle: "কোনো ঝামেলা ছাড়াই মাত্র ১ সেকেন্ডে সাইজ অ্যাডজাস্ট ও ক্লিন করুন",
    steps: [
      {
        number: "০১",
        title: "চাপ দিয়ে সাইজ তৈরি করুন (Pinch to 3 Sizes)",
        desc: "হ্যান্ডেলের দাগ অনুযায়ী চাপ দিলেই ভাঁজ হয়ে তৈরি হবে ১/৪ চা চামচ থেকে শুরু করে ২ টেবিল চামচের মাপ।",
        image: "/uploads/media-1787681475090-937220178.webp"
      },
      {
        number: "০২",
        title: "লিক-প্রুফ পরিমাপে তুলে নিন (LeakProof Scoop)",
        desc: "লিক-প্রুফ ডিজাইনে গুঁড়া মসলা কিংবা তেল-মধু নিখুঁত মাপে কোনো ছিটে যাওয়া ছাড়াই তুলুন।",
        image: "/uploads/media-1787681854644-265275869.webp"
      },
      {
        number: "০৩",
        title: "ফ্ল্যাট করে ধুয়ে রাখুন (Flat Clean & Store)",
        desc: "ব্যবহার শেষে ফ্ল্যাট করে ট্যাপের পানিতে ধুয়ে ড্রয়ারে বা ম্যাগনেটিক স্ট্রিপে রেখে দিন।",
  ...
  reviews: [
    {
      ...
      rating: 5,
      comment: "Baking lover হিসেবে এটা আমার জন্য লাইফ সেভার। আগে আলাদা ৬টা চামচ ড্রয়ারে খুঁজতে হতো, এখন এই ২টা দিয়ে ১/৪ চা চামচ থেকে ২ টেবিল চামচ পর্যন্ত সব মেপে নিই।",
      verified: true,
      date: "৩ দিন আগে"
    },
    {
      ...
      rating: 5,
      comment: "বাচ্চাদের ওষুধের সঠিক পরিমাপ আর সকালের ডায়েট ফুডের ওটস ও চিয়া সিড মেপে নেওয়ার জন্য দারুণ। DuraBend কোয়ালিটি সত্যিই মজবুত। ব্যবহারের পর এক টানে ধুয়ে ফেলা যায়।",
      verified: true,
      date: "৫ দিন আগে"
    },
    {
      ...
      rating: 5,
      comment: "মধু আর ঘি নেওয়ার পর সাধারণ চামচ ধুতে গরম পানি আর ঘষাঘষি লাগতো। এটা ফ্ল্যাট করে স্প্যাচুলার মতো কড়াইতে চেঁছে নামিয়ে টিস্যু দিয়ে মুছলেই সাফ! লিক-প্রুফ ফিচারটা অসাধারণ।",
      verified: true,
      date: "১ সপ্তাহ আগে"
    },
    {
      ...
      rating: 5,
      comment: "সোশ্যাল মিডিয়ায় ভিডিও দেখে অর্ডার করেছিলাম। ছবির চেয়ে বাস্তবেও দেখতে অনেক প্রিমিয়াম ও আকর্ষণীয় মেরুন রঙের। ২ সেটের ফ্যামিলি প্যাক নিয়েছিলাম গিফট বক্সসহ, একদম ফ্রি ডেলিভারিতে পেয়েছি।",
      verified: true,
      date: "১ সপ্তাহ আগে"
    },
    {
      ...
      rating: 5,
      comment: "আমার বেকিং শপের জন্য ২ সেট অর্ডার করেছিলাম। নিখুঁত মাপ এবং ১ লাখ বার ফোল্ড করার মতো মজবুত ফুড-সেফ পলিমার। ডেলিভারি ম্যানের সামনে প্যাকেট খুলে চেক করে টাকা দিয়েছি।",
      verified: true,
      date: "২ সপ্তাহ আগে"
    },
    {
      ...
      rating: 5,
      comment: "রান্নাঘরে চামচের ড্রয়ারে জটলা সবসময় অপছন্দ ছিল। এটা কাগজের মতো পাতলা হয়ে এক কোণে পড়ে থাকে এবং ফ্রিজের গায়ে ম্যাগনেট দিয়ে লাগানো যায়। অসাধারণ ইনোভেশন!",
      verified: true,
      date: "২ সপ্তাহ আগে"
    }
  ],
