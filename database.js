...
const defaultOrigamiPageData = {
  ...
  hero: {
    ...
    headline: "রান্না ও বেকিংয়ে নিখুঁত মাপের 4-in-1 ফোল্ডিং মেজারিং চামচ",
    subheadline: "১টি চামচেই ৪টি নিখুঁত পরিমাপ এবং ১ সেকেন্ডে ফ্ল্যাট করে তেল-মধু পরিষ্কারের আধুনিক সল্যুশন।",
    highlights: [
      "⚡ ৪টি সাইজ ১টি চামচে: ১টি চামচ দিয়েই পাবেন ৪টি ভিন্ন পরিমাপ।",
      "🍯 ১ সেকেন্ডে ইজি ক্লিন: ফ্ল্যাট করে এক টানে সমস্ত তেল বা মধু পরিষ্কার।",
      "🛡️ ১০০% ফুড গ্রেড পলিমার: প্রিমিয়াম কোয়ালিটি ও আনব্রেকেবল মেটেরিয়াল।"
    ],
  ...
  problemSolution: {
    ...
    subtitle: "সাধারণ চামচের সমস্যা বনাম আমাদের ৪-ইন-১ অরিগামি স্পুনের আধুনিক সমাধান",
    cards: [
      {
  ...
  reviews: [
    {
      ...
      rating: 5,
      comment: "Baking lover হিসেবে এটা আমার জন্য লাইফ সেভার। আগে আলাদা ৪টা স্পুন ড্রয়ারে খুঁজতে হতো, এখন এই ১টা দিয়ে ১/৪ চামচ থেকে ১ টেবিল চামচ পর্যন্ত সব মেপে নিই। মেটেরিয়াল কোয়ালিটি অনেক প্রিমিয়াম।",
      verified: true,
      date: "৩ দিন আগে"
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      comment: "আমার বেকিং শপের জন্য ২ সেট অর্ডার করেছিলাম। নিখুঁত মাপ এবং খুব মজবুত পলিমার। ডেলিভারি ম্যানের সামনে প্যাকেট খুলে চেক করে টাকা দিয়েছি। ১০০% সন্তুষ্ট।",
      verified: true,
      date: "২ সপ্তাহ আগে"
    },
    {
  ...
  faq: [
    {
      ...
      a: "একদমই না। এটি প্রিমিয়াম ফুড-গ্রেড BPA-ফ্রি TPE মেটেরিয়াল ও ট্রায়াঙ্গেল হিঞ্জ টেকনোলজিতে তৈরি, যা ১০০,০০০ বারের বেশি ফোল্ড করলেও কোনো দাগ, ভাঁজের দাগ বা চিড় ধরবে না।"
    },
    {
      q: "মধু, ঘি বা তেলের মতো আঠালো জিনিস সহজে কীভাবে পরিষ্কার করবো?",
      a: "চামচটি সম্পূর্ণ ফ্ল্যাট করে কড়াইতে সম্পূর্ণ মধু বা তেল চেঁছে নামিয়ে নিন। এরপর সাধারণ সাবান-পানি দিয়ে ধুয়ে নিলে বা টিস্যু দিয়ে ওয়াইপ করলেই ১ সেকেন্ডে নতুনের মতো পরিষ্কার হয়ে যাবে।"
    },
    {
      q: "এর চারটি পরিমাপের সাইজ কত কত?",
      a: "হ্যান্ডেলে সুস্পষ্ট মার্কিং দেওয়া রয়েছে: ১/৪ চা চামচ (১.২৫ মিলি), ১/২ চা চামচ (২.৫ মিলি), ১ চা চামচ (৫ মিলি), এবং ১ টেবিল চামচ (১৫ মিলি)। বড় চামচ ও ছোট চামচ—২টি মিলে যেকোনো তরল বা গুঁড়ো উপাদান নিখুঁত মাপা যায়।"
    },
    {
